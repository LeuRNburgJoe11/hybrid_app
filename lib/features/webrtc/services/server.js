...
// server.js 
// Replace your entire app.post('/api/handshake-escalation', ...) block with this version:
// 3. CHATBOT INVOKE API ENDPOINT: Generates room details + Cloudflare tokens instantly
// 3. CHATBOT INVOKE API ENDPOINT: Generates room details + Cloudflare tokens instantly
app.post('/api/handshake-escalation', async (req, res) => {
  try {
    ...
    const cfResponse = await axios.post(
      `https://api.cloudflare.com/client/v4/accounts/${ACCOUNT_ID}/calls/turn_keys/${TURN_KEY_ID}/credentials`,
